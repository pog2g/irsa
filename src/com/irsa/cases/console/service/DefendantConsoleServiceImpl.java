        ...
        try {
            ...
            if (StringUtils.isNotBlank(pid)) {
               ...
               /* update irsa_defendant set type_id = ?, unit_name = ?, unit_content = ?, unit_abode = ?, name = ?, legal_person_type = ?, duty = ? where id = ?*/
                ...
                defendantManager.executeSQL(Defendant.INSERT, new Object[]{personnelId, Utils.getCreateTime(), type , unit_name, name, unit_contact, unit_abode, name, legal_person_type, duty, "", ""});
            }    
