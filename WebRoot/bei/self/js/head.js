var header = "<a href='index.html' class='logo'>" +
	"<span class='logo-mini'><img src='self/img/logo-new-mini.png' style='width: 100%;padding: 8px 0;'/></span>" +
	"<span class='logo-lg'><img src='self/img/logo-new.png' style='width: 50%;'/></span>" +
	"</a>" +
	...
	"<a href='login.html' style='padding: 22px 10px;'>" +
