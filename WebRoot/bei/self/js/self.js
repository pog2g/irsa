...
function initAccount1(webpage) {
    ...
    var data = {
        ...
        "data": {
            ...
            "competence": [{
                ...
                "id": "li_home",
                "text": "复议应答列表",
                "url": "index.html?web=li_home"
            }, {
                "icon": "fa-th",
                "id": "case_data",
                "text": "单位应议资料",
                "url": "case_data.html?web=case_data"
            }, {
                "icon": "fa-th",
                "id": "page3",
                "text": "参与网上听证",
                "url": "development.html?web=page3"
            }, {
                "icon": "fa-th",
                "id": "page4",
                "text": "已结复议案件",
                "url": "development.html?web=page4"
            }, {
                "icon": "fa-th",
                "id": "page5",
                "text": "未经诉论结案",
    ...
    if (data.result == 1) {
        ...
        $.each(data.data.competence, function (index, value) {
            if (value.id == webpage) {
                html += "<li id='" + value.id + "'  class='active' ><a href='" + value.url + "'><i class='fa fa-th'></i> <span>" + value.text + "</span></a></li>";
            } else {
                html += "<li id='" + value.id + "' ><a href='" + value.url + "'><i class='fa fa-th'></i> <span>" + value.text + "</span></a></li>";
            }
        });
        var menu = $("#ul_menu");
        menu.empty();
